...
- 3개 bullet 외에 더 짚을 내용이 있으면 \`moreNote\` 필드에 30~60자로 **추가 검토 영역 힌트**만 적기 (구체 답은 안 적음 — 상세 컨설팅 유도용 티저). 추가할 게 없으면 빈 문자열.
...
[반환 JSON 스키마]
{
  ...
  "sections": {
    "management": {
      ...
      "moreNote": "예: '조직·인력 효율화 측면 추가 분석 가능' / 빈 문자열도 허용"
    },
    "sales": {
      "title": "매출관리·마케팅 확대",
      "bullets": [
      ...
      "moreNote": "예: '나머지(해외매출/라이센싱 등) 가능성도 별도 검토 여지' / 빈 문자열도 허용"
    },
    "taxRefund": {
      "title": "경정청구·세액공제",
      ...
      "moreNote": "예: '추가 공제 항목 1~2개 더 검토 가능' / 빈 문자열도 허용"
    },
    "powerCost": {
      "title": "전력비 분석",
      "bullets": [
      ...
      "moreNote": "예: '실측 데이터 기반 정밀 절감 분석 별도 가능' / 빈 문자열도 허용"
    },
    "policySupport": {
      "title": "정책지원 검토",
      "bullets": [
      ...
      "moreNote": "예: '지자체·업종별 자금까지 확장 검토 가능' / 빈 문자열도 허용"
    }
  },
  "retainedEarnings": {
